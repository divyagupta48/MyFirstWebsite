...
{
echo "<center><h1>You have not created any discussions yet...!!!</h1></center>";
}
else
{
...
while($row=mysqli_fetch_array($result))
{
	...
	echo "<input type='hidden' name='var' value=$row[topic_id]><input type='submit' value='View Discussion'></form></td></tr>";
}
}
echo "</table>";
	?>
